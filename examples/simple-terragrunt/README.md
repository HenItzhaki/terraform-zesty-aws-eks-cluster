...
This example shows how to onboard one AWS account to Zesty and deploy the Kompass Helm chart into one Amazon EKS cluster by using Terragrunt.
...
1. `account/` onboards the AWS account to Zesty.
